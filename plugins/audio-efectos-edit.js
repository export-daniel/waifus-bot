...
let set
function replyToAudio() { m.reply(lenguajeBot.smsControlAudio1())}
function replyToNumber() { m.reply(lenguajeBot.smsControlAudio2(usedPrefix, command))}
        
// -- bass -- //
if (/edit(ed|ar)?bass/.test(command)) {
if (!args[0] || !args[1]) return  m.reply(lenguajeBot.smsAudioEdit1(usedPrefix, command))
...
m.reply(`*🎧 ${lenguajeBot.smsControlAudio5()}*\n\`\`\`${set.replace(/:/g, ':\n')}\`\`\`\n1️⃣ *${f}* 2️⃣ *${g}* 3️⃣ *${width_type}* 4️⃣ *${width}*`)
}
        
// -- vibra -- //
if (/edit(ed|ar)?vibra/.test(command)) {
if (!args[0] || !args[1]) return m.reply(lenguajeBot.smsAudioEdit2(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
let f, d
...
if (!args[0] || !args[1]) return m.reply(lenguajeBot.smsAudioEdit3(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) return m.reply(lenguajeBot.smsAudioEdit4(usedPrefix, command))
let atempo, asetrate
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0]) throw lenguajeBot.smsAudioEdit5(usedPrefix, command)
...
if (!args[0] || !args[1]) return m.reply(lenguajeBot.smsAudioEdit6(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
let tempo, setrate
...
if (!args[0] || !args[1]) return m.reply(lenguajeBot.smsAudioEdit7(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
let tempo, setrate
...
if (!args[0] || !args[1]) return m.reply(lenguajeBot.smsAudioEdit8(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) return m.reply(lenguajeBot.smsAudioEdit9(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) return m.reply(lenguajeBot.smsAudioEdit10(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) return m.reply(lenguajeBot.smsAudioEdit11(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) return m.reply(lenguajeBot.smsAudioEdit12(usedPrefix, command))
...
if (!args[0] || !args[1]) return m.reply(lenguajeBot.smsAudioEdit13(usedPrefix, command))
...
if (err) return m.reply(lenguajeBot.smsControlAudio3())
let buff = await readFileSync(filename)
conn.sendFile(m.chat, buff, ran, null, m, true, {
type: 'audioMessage', 
ptt: true 
})})
} else return m.reply(lenguajeBot.smsControlAudio4())
} catch (e) {
return e
}}
