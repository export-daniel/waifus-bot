...
switch (true) {     
case isCommand1:
if (!text) return m.reply(lenguajeBot.smsMalused2() + `\n*${usedPrefix + command} Waifus*`)
...
let link = image
conn.sendFile(m.chat, link, 'error.jpg', `${lenguajeBot.smsImageGg()} ${text}`, m)
} catch (e) {
reportError(e)
} 
break
...
case isCommand2:
if (!text) return m.reply(lenguajeBot.smsMalused2() + `*${usedPrefix + command} Billie Eilish - Bellyache*`)
try{    
if (command == 'play') { 
let vid = (await yts(text)).all[0]
const yt_play = await search(args.join(" "))
if (!yt_play) return m.reply(lenguajeBot.smsMalError2() + `_${lenguajeBot.smsYT6()}_`)
...
case isCommand4:
if (!args[0]) return m.reply(lenguajeBot.smsMalused2() + `*${usedPrefix + command} https://youtu.be/ejemplo*\n*${usedPrefix + command} https://www.youtube.com/ejemplo*`)
await conn.reply(m.chat, lenguajeBot.smsAvisoEG() + '*' + lenguajeBot.smsYTA1() + '*', m)
try {
q = '128kbps'
v = args[0]
...
case isCommand5:
if (!args[0]) return m.reply(lenguajeBot.smsMalused2() + `*${usedPrefix + command} https://youtu.be/ejemplo*\n*${usedPrefix + command} https://www.youtube.com/ejemplo*`)
await conn.reply(m.chat, lenguajeBot.smsAvisoEG() + '*' + lenguajeBot.smsYTA2() + '*', m)
let vid = (await yts(text)).all[0]
const yt_play = await search(args.join(" "))
let { title, description, url, thumbnail, videoId, timestamp, views, published } = vid
try {
...
case isCommand6:
if (!args[0]) return m.reply(lenguajeBot.smsMalused2() + `*${usedPrefix + command} https://youtu.be/ejemplo*\n*${usedPrefix + command} https://www.youtube.com/ejemplo*`)
await conn.reply(m.chat, lenguajeBot.smsAvisoEG() + '*' + lenguajeBot.smsYTV1() + '*', m)
try {
qu = '360'
q = qu + 'p';
v = args[0]
...
case isCommand7:
if (!args[0]) return m.reply(lenguajeBot.smsMalused2() + `*${usedPrefix + command} https://youtu.be/ejemplo*\n*${usedPrefix + command} https://www.youtube.com/ejemplo*`)
await conn.reply(m.chat, lenguajeBot.smsAvisoEG() + '*' + lenguajeBot.smsYTV2() + '*', m)
try {
qu = args[1] || '360'
q = qu + 'p'
v = args[0]
...
if (!args[0].match(/www.facebook.com|fb.watch|web.facebook.com|business.facebook.com|video.fb.com/g)) throw lenguajeBot.smsAvisoFG() + lenguajeBot.smsyFBvid1()
await m.reply(wait)
let messageType = checkMessageType(args[0])
let message = ''
switch (messageType) {
case "groups":
message = lenguajeBot.smsyFBvid2()
break
case "reel":
message = lenguajeBot.smsyFBvid3()
break
case "stories":
message = lenguajeBot.smsyFBvid4()
break
case "posts":
message = lenguajeBot.smsyFBvid5()
break
default:
message = lenguajeBot.smsyFBvid6()
break
}  
try {
...
case isCommand9:
if (!args[0]) return m.reply(lenguajeBot.smsMalused2() + `*${usedPrefix + command} https://www.mediafire.com/file/04kaaqx9oe3tb8b/DOOM_v13_CLONE%255BCOM.FM%255D.apk/file*`)
try {  
...
case isCommand11:
if (!text) return conn.reply(m.chat, `${lenguajeBot['smsMalused2']()}\n*${usedPrefix + command} https://vm.tiktok.com/ZM2e66NBM/?t=1*`, m)
if (!/(?:https:?\/{2})?(?:w{3}|vm|vt|t)?\.?tiktok.com\/([^\s&]+)/gi.test(text)) return conn.reply(m.chat, `${lenguajeBot['smsAvisoFG']()}*${lenguajeBot['smsYT6']()}*`, m)  
try {
const { author: { nickname }, video, description, audio } = await tiktokdl(args[0])
.catch(async _ => await tiktokdlv2(args[0]))
.catch(async _ => await tiktokdlv3(args[0]))
const url = video.no_watermark2 || video.no_watermark || 'https://tikcdn.net' + video.no_watermark_raw || video.no_watermark_hd
await conn.reply(m.chat, `${lenguajeBot['smsAvisoEG']()}*${lenguajeBot['smsTiktok']()}*`, m)    
await conn.sendFile(m.chat, url, 'tiktok.mp4', `*${nickname}*`.trim(), m)
...
text = m.quoted.text
} else return conn.reply(m.chat, `${lenguajeBot['smsMalused3']()}\n*${usedPrefix + command} ${lenguajeBot.smsIAimage2()}*`, m)
await m.reply(wait) 
try{   
let response = await fetch(`https://api.lolhuman.xyz/api/diffusion-prompt?apikey=${lolkeysapi}&prompt=${text}`)
let image = await response.buffer()
await conn.sendFile(m.chat, image, 'image.jpg', lenguajeBot.smsIAimage() + `\n\n_${text}_`, m)
} catch {
try{
let res = `https://api.lolhuman.xyz/api/dall-e?apikey=${lolkeysapi}&text=${text}`  
await conn.sendFile(m.chat, res, 'image.jpg', lenguajeBot.smsIAimage() + `\n\n_${text}_`, m)
} catch (e) {
reportError(e)} 
}        
break
...
text = m.quoted.text
} else return conn.reply(m.chat, `${lenguajeBot['smsMalused3']()}\n*${usedPrefix + command} ${lenguajeBot.smsIAimage4()}*`, m)
m.reply(wait)
try {
await Draw(text).then((img) => {
conn.sendFile(m.chat, img, 'image.jpg', lenguajeBot.smsIAimage3() + `\n\n_${text}_`, m)
})
} catch (e) {
reportError(e)}        
break
...
case isCommand15:
if (!text) return m.reply(lenguajeBot.smsMalused2() + `*${usedPrefix + command} Runaway*\n\n*${usedPrefix + command} https://open.spotify.com/track/23rdcrD0Eky4vYn2TZidxJ*\n\n${lenguajeBot.smsSP0(usedPrefix)}`)
try {
...
let spotifyi = `${lenguajeBot.smsSP1()}
⭔ _${spty.data.name}_
...
case isCommand16:
if (!text) return m.reply(lenguajeBot.smsMalused2() + `*${usedPrefix + command} Bellyache*`)
let res = await fetch(`https://api.lolhuman.xyz/api/spotifysearch?apikey=${lolkeysapi}&query=${encodeURIComponent(text)}`)
let json = await res.json()
if (json.status != '200') return m.reply(lenguajeBot.smsSP6())
try{
...
ini_txt += `\n\n${lenguajeBot.smsSP1()} ${sh.title} | ${formatted}\n`
ini_txt += `${lenguajeBot.smsSP2()} ${sh.artists}\n`
ini_txt += `${lenguajeBot.smsSP3()} ${sh.link}\n`
ini_txt += ``
}
await m.reply(wait)
...
case isCommand17:
if (!args[0]) return m.reply(lenguajeBot.smsMalused2() + `*${usedPrefix + command}* ` + 'https://www.instagram.com/reel/CrWooCiKGKP/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA==')
try{
...
if (!text) return m.reply(lenguajeBot.smsMalused2() + `*${usedPrefix + command}* ` + 'https://twitter.com/gofoodindonesia/status/1229369819511709697')
try{ 
...
case isCommand19:
if (!text) return m.reply(lenguajeBot.smsMalused2() + `*${usedPrefix + command}* ${md}/author/repositorio`)
//await m.reply(`*${lenguajeBot.smsGit()}*`);
conn.reply(m.chat, `${lenguajeBot.smsAvisoEG()} ${lenguajeBot.smsGit()}`, m, {
