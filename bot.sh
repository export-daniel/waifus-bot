...
COMANDOS = "pkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/export-daniel/waifus-bot\ncd waifus-bot\nyarn install\nnpm install\nnpm start"
...
echo -e "\033[1;35m"
git clone https://github.com/export-daniel/waifus-bot.git
...
echo -e "\033[01;32m\033[01mIniciando il.ẉaifus.bot.il!!\nStarting il.ẉaifus.bot.il!!\n\033[0m"
npm start
